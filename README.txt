...
压缩后，它只有800k，解压后只有 2M，一共406个文件。但是你知道它有多强大吗？
	...
	5. 基于自行研发的 PHP Framework 开发，MVC 层次清楚，便于扩展。
...
【关于 Xiuno Framework】
它只有340K，34个文件。
在开发Xiuno BBS 的过程中开发了 Xiuno Framework，用来分离公共模块，它良好的封装了各种DB, CACHE，对上层只提供了12个方法，只需要掌握这12个方法，开发者就可以任意操作各种DB,CACHE。
...
【如何二次开发？】
1. 程序采用MVC方式组织代码，插件使用了AOP机制，开发过程简单，不受主程序升级影响，一次写好，终生使用（这么说有点像国内某些吹牛皮的广告~，但是确实是这样）。
