...
Xiuno BBS 是一款面向大数据量高负载开发的论坛，最早用于国内某知名论坛，用于解决论坛运行效率问题，经过一次彻底的重构，诞生了 Xiuno BBS 2.0 这个令作者都感到激动的版本。
Xiuno BBS 2.0 是经过实际高负载论坛考验过的，除了个别第三方类库，全部代码由作者一人完成，从设计到实现高度统一，它是非常安全稳定的。
压缩后，它只有700k，解压后只有 2M，一共406个文件。但是你知道它有多强大吗？
	在程序方面：
	...
	7. 支持全站 LOW_PRORITY，让 MySQL 在高负载下尽可能的不再锁表。
